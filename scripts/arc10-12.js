...
(function(){
  ...
  const ARC11_CHAPTER_SCENES = {
    ...
    6: "The lights aren't random after all — they form an actual pattern.<br><br>Renn's first instinct is to write it off as some natural phenomenon. Erynn isn't so sure; she notices the pattern repeats at measured, deliberate intervals — nothing about that reads as natural to her.<br><br>Mimi is the one who says what the other two are dancing around. She can feel intention behind it. She just can't tell yet whether it's coming from a person, a creature, or something built.",
