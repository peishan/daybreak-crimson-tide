(function(){
  ...
  const ARC17_CHAPTERS = [
    ...
    {id:5, title:'Someone Has Been Here Before', focus:"The crew discovers evidence that someone has accessed the Archive relatively recently — not ancient explorers, someone who understood the systems. Renn recognizes one of the markings. He doesn't know why.", image:'assets/comics/arc17/ch05-someone-has-been-here-before.png', xp:310, action:'🔍 Investigate the Traces'},
    {id:6, title:'Familiar', focus:"Renn starts recognizing things — not memories exactly, more like instinct. He knows which symbols mark restricted areas and understands mechanisms without being taught. Everyone notices. Renn doesn't.", image:'assets/comics/arc17/ch06-familiar.png', xp:300, action:'👁️ Notice Something Familiar'},
    {id:7, title:'The Language of the Archive', focus:"Renn discovers he can partially read an ancient archival language. Erynn is fascinated — but Mimi points out that Renn isn't translating it. He's remembering how it works.", image:'assets/comics/arc17/ch07-the-language-of-the-archive.png', xp:290, action:'📖 Read Without Translating'},
    {id:8, title:"The House That Wasn't Empty", focus:"The crew finds evidence this wasn't merely an institution — there were homes, schools, workshops, families. Renn begins to realize this wasn't just somewhere his people studied. It was somewhere they lived.", image:'assets/comics/arc17/ch08-the-house-that-wasnt-empty.png', xp:300, action:"🏘️ Walk Through Their Home"},
    ...
    {id:10, title:'I Know This Place', focus:"Renn admits he doesn't remember everything, but he knows this place — not intellectually, emotionally. He has been here before. San decides they won't force him to remember; they'll let him choose how much to discover.", image:'assets/comics/arc17/ch10-i-know-this-place.png', xp:320, action:'💭 Let Him Choose'},
    ...
    {id:18, title:'Renn', focus:"The crew finally discovers records relating directly to Renn — not a prophecy, a person. He came from this world, part of the final generation connected to the Archive. How he ended up separated from it remains uncertain.", image:'assets/comics/arc17/ch18-renn.png', xp:330, action:'📜 Read His Own Record'},
    {id:19, title:'What Renn Remembers', focus:"Renn's memories begin returning in fragments — a home, people, a departure, fear, and someone telling him he had to leave. The circumstances remain incomplete.", image:'assets/comics/arc17/ch19-what-renn-remembers.png', xp:320, action:'🧠 Let the Memory Surface'},
    {id:20, title:'Home', focus:'Renn walks through a place he once knew. There is no dramatic magical awakening — he simply realizes he grew up here. San stays beside him without telling him what he should feel.', image:'assets/comics/arc17/ch20-home.png', xp:340, action:'🏡 Walk Through Home'},
  ...
  const ARC17_CHAPTER_SCENES = {
    1: "The readings come in during a routine sweep — nothing about the setup suggested this would be anything but a normal check of the boundary.<br><br>It isn't a world out there. Renn is sure of that within minutes, and surer still the longer he stares at it. It isn't a normal Horizon either, not the shape those usually take. What it actually resembles, if he's being precise about it, is a signal — structured, deliberate, embedded directly into the boundary itself rather than sitting somewhere beyond it.<br><br>\"Can we reach it?\" San asks, because that's always the first question that matters.<br><br>\"That's the interesting part,\" Renn says, and doesn't look up from the readings once.",
    ...
    5: "The signs are small, easy to miss if you aren't looking for them — but once Erynn points them out, they're unmistakable. Someone has been here. Not ancient explorers, not whoever built this place originally. Someone recent. Someone who understood the systems well enough to move through them without disturbing what wasn't meant to be disturbed.<br><br>Renn stops in front of one particular marking, and something in his expression changes before he says a word.<br><br>He recognizes it. He can't explain how, and that bothers him more than not recognizing it would have.",
    6: "It starts small enough that nobody thinks to mention it at first.<br><br>Renn reaches for a lever before anyone tells him what it does, and it's the right one. He steps around a section of floor that turns out, when Zaki checks afterward, to have been unstable for centuries. He knows, without being able to say how, which doors in this wing are the ones you don't open.<br><br>Nobody says anything about it out loud. Not yet. Renn hasn't noticed doing it, and everyone else is still deciding whether pointing it out would help or just make it worse.",
    7: "Erynn hands Renn a fragment of archival text mostly to see what he makes of it — a linguist's habit, testing an unfamiliar script against a sharp mind.<br><br>Renn reads it. Not slowly, not the halting sentence-by-sentence work of translation. He reads it the way you read something you already know.<br><br>Erynn is delighted, right up until Mimi says the thing that changes the mood in the room. \"That's not translating,\" Mimi says quietly. \"That's remembering.\"",
    ...
    13: "It's Renn who makes the connection, staring at a diagram that shouldn't mean anything to him and somehow does.<br><br>The Door from all those months ago — the one that led nowhere anyone could explain, the one that started all of this for him personally — isn't an isolated anomaly. It's a node. One piece of a network this Archive was built to map, cataloged here under a designation that predates the name Renn ever gave it.<br><br>He'd been connected to this the whole time, unknowingly, long before any of them understood what \"connected\" even meant in this context.<br><br>\"It wasn't random,\" he says slowly. \"None of it was ever random.\"",
    ...
    15: "It takes Erynn longer than it should to realize what he's actually looking at — not gaps in the record from age or damage, but a section removed. Deliberately. Carefully. By someone who knew exactly what they were taking out.<br><br>Whoever did this didn't want this specific history lost by accident. They wanted it gone on purpose.<br><br>Renn goes very still once he realizes which period the missing pages cover. Not the Archive's early history. Not the Farseers, or the first boundary work.<br><br>The end. Whatever happened to his own people, right at the close of it, someone made sure nobody would find it easily.<br><br>He doesn't say much for the rest of the day.",
    16: "What survives, once you piece the surrounding fragments together, is a picture of a civilization that had grown more dependent on inter-world travel than any before it — and more divided over what to do with that dependence.<br><br>The records don't paint it as one clean argument. There were people who wanted to keep exploring, further and further, for its own sake. People who saw the other worlds as resources to draw from. People who wanted contact — real contact, relationships between civilizations, not just access. People who wanted control over all of it, and weren't particular about how they got it.<br><br>Nobody in these records is simply right. Renn reads faction after faction and recognizes fragments of arguments he's had himself, on this very ship, about very different things.",
    17: "Something broke. That much is certain by the time Renn and Erynn finish reconstructing the sequence — though exactly what, and whether it was damage or a deliberate shutdown, the records don't agree on cleanly.<br><br>Whatever it was, it worked. The inter-world network that connected all of this simply stopped, and the worlds it had linked went quiet, one by one, cut off from each other in a way none of them had prepared for.<br><br>The Archive survived. It's still standing, still humming faintly in places, centuries later. But the civilization that built it didn't survive with it — not intact, not in the shape it had been.<br><br>Renn doesn't ask whose fault it was. He's starting to suspect the records won't have a clean answer to that either.",
    18: "They find it in a section Renn almost doesn't let them open.<br><br>Not a prophecy. Not the shape of a story where someone turns out to be chosen for something. A person. A record, plain and unremarkable in the way real records usually are, connecting him — not a resemblance, not a family line this time, him — to the final generation this Archive ever recorded in full.<br><br>Renn came from here. That part is no longer a guess.<br><br>What isn't in the record is how he ended up separated from all of it — from this place, this history, everyone this ledger says he belonged to. That part stays unanswered, for now. San watches him read it twice, and doesn't fill the silence with anything.",
    19: "It doesn't arrive as a single overwhelming flood, the way Renn half-expected it might if it ever came at all. It arrives in pieces, uneven and out of order, the way real memory actually works.<br><br>A home — not this Archive exactly, but somewhere close enough to it that the two blur together. People, half-formed, faces he can't quite hold onto long enough to describe. A departure, sudden enough that it still carries urgency even now. Fear, real and specific, not the vague unease he's been carrying since Chapter 6.<br><br>And someone — he can't say who yet — telling him he had to leave.<br><br>That's where it stops. Not everything. Enough.",
    20: "There's no dramatic moment to it, in the end. No flash of magic, no sudden completion of everything Chapter 19 left open.<br><br>Renn simply walks into a room that means something specific to him — more specific than anywhere else in the Archive has — and stands there for a while, taking in details nobody else would notice.<br><br>\"I grew up here,\" he says, finally. Not a question. Not a revelation delivered for effect. Just a fact, settling into place after being unspoken for far too long.<br><br>San stays beside him. She doesn't tell Renn what he should be feeling, doesn't fill the quiet with reassurance Renn hasn't asked for. She just stays, for as long as Renn needs her to.",
    ...
    23: "Something shifts, the moment Renn steps into the restored chamber — not dramatically, but unmistakably. Systems that have stayed dark through every other room flicker on, one after another, responding to something about him specifically that no one else aboard triggers.<br><br>It isn't recognizing a hero. It isn't recognizing anyone chosen for anything.<br><br>It's recognizing where he's from.<br><br>Access opens that had stayed closed through every prior chapter — not everything, not all at once, but enough. For the first time since this arc began, Renn has an actual way to learn about his own people, instead of piecing them together from fragments and family ledgers.",
    24: "There's more knowledge in this Archive than the Crimson Tide could carry home in a hundred trips, and San is aware, standing in the middle of it, of exactly how tempting that is.<br><br>They don't take it. Not like that.<br><br>What they settle on instead is closer to a set of rules than a haul: preserve what's here rather than strip it. Copy only what they actually have permission to study. Don't treat an abandoned world like a resource just because no one's left to say no. Don't force open a sealed route simply because it's possible to.<br><br>Renn chooses to stay connected to the Archive's preservation — this is his, in a way it will never quite be anyone else's aboard the ship. But when the Crimson Tide sails, he sails with it.<br><br>\"This is home too,\" he says, and doesn't have to explain to anyone why that's true now in a way it wasn't before.",
    25: "It's a quiet chapter, the way the important ones sometimes are.<br><br>Renn starts small — a single shelf at Fair Tide, nothing like the vast structure they just left behind. Erynn contributes what he can pull from the Farseer records. Mimi adds what she's willing to commit to paper from things that mostly can't be proven yet. Renn catalogs all of it himself, patient in a way San hasn't seen from him before.<br><br>San watches him work for a while before Joel finally asks the question everyone's been circling.<br><br>\"So what are you now?\"<br><br>Renn thinks about it longer than the question probably needed.<br><br>\"I suppose I'm an archivist.\"<br><br>\"You were already an Archive Mage,\" San says.<br><br>\"Yes,\" Renn says. \"But now I know why.\"<br><br>Far away, in a structure that hasn't drawn a new breath in thousands of years, something quietly activates. A system built to detect exactly one thing, doing precisely what it was built to do.<br><br>Another Horizon signature. Not from Veyren.<br><br>Somewhere else."
  };
  ...
  window.arc17ObjectiveState = function(){
    ...
    return 'arc17_all_chapters_complete';
  };
  ...
  window.renderStory = function(){
    ...
    if (so==='arc17_all_chapters_complete'){
      html += '<div class="story-chapter" style="margin-top:8px;"><div class="story-chapter-sub">✓ Arc XVII complete — every chapter of The Archive Between Worlds has been read.</div></div>';
    }
    html += '</section>';
    container.insertAdjacentHTML('beforeend', html);
  };
