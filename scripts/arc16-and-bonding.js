(function(){
  ...
  const ARC16_CHAPTER_SCENES = {
    ...
    6: "San sits with it longer than she means to.<br><br>The Horizon Engine needs the material. That part isn't in question — she's seen the readings herself, run the numbers twice. What she keeps circling back to is the other half of the equation: needing something has never, on its own, been the same as being entitled to it.<br><br>She doesn't have an answer yet. She's honest enough with herself to notice that bothers her more than not having the material would.",
