(function(){
  ...
  const ARC16_CHAPTER_SCENES = {
    ...
    7: "Renn lays it out the way he lays everything out — plainly, thoroughly, without embellishment. What the material could do for the Engine. What it could do beyond the Engine, if they're being honest about its properties. The case for taking it is, by his account, a strong one.<br><br>Erynn doesn't dispute a word of it. That's not where his objection lives.<br><br>\"Useful and valuable aren't the same thing,\" he says. \"Something can be worth everything to the people who live around it and worth nothing on Renn's chart at the same time. We haven't asked what it's worth to them. We've only worked out what it's worth to us.\"<br><br>Joel's listened to all of it without saying much. When he finally does, it isn't about value at all.<br><br>\"Say we take it,\" he says. \"What does that actually look like — for us, tomorrow, for whoever's still here after we've gone? Because nobody's said that part yet.\"<br><br>He doesn't wait for either of them to answer before he lets the question sit.",
    ...
    13: "The guardians don't just explain what the material does. They explain what it's part of — root systems, weather patterns, the dragons' own migrations, a dozen things Erynn hadn't thought to ask about because he'd been treating this like a mineral deposit instead of something closer to an organ.<br><br>It isn't protected because someone once decided, arbitrarily, that it should be. It's protected because pulling it out wrong would be like pulling something load-bearing out of a structure and hoping the rest holds anyway. Everything here grew up assuming it would stay exactly where it is.<br><br>Renn writes it all down. For the first time since this began, he isn't sure the numbers are the part that matters most.",
